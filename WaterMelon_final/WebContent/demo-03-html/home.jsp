			...
			<div class="master-container-fluid header-inner mb-3 mb-md-4 mt-3">
				<div class="row justify-content-between">
					<div class="col-auto col-xl-3 d-flex align-items-center pr-0">
						<div class="brand">
							<a class="brand d-flex align-items-center nav-link adonis-ajax-load" href="homl.jsp#site-content" data-target="homl.jsp#site-content" data-content="homl.jsp"> 
							<!-- <a class="nav-link adonis-ajax-load" href="single-album.html" data-target="single-album.html" data-content="../demo-03-html/single-album.html">수민</a> -->
					...
					<div
						...
						<div class="nav-item d-none d-md-flex">
							<a class="nav-link notification-toggle has-notification" href="/WaterMelon/notice.water"
						...
						<div class="nav-item position-relative">
							<a class="nav-link dropdown-toggle w-nowrap pl-0 pr-0 pl-md-3"
								...
								<div class="flex-row d-inline-flex">
									...
									<span class="ml-2 mt-2 fs-1 d-none d-lg-block"><%=session.getAttribute("nickName")%></span>
								</div>
							</a>
							<div
								...
								<div class="settings-bottom">
									<h5 class="user-name text-center"><%=session.getAttribute("nickName")%></h5>
									<ul class="user-settings-menu list-unstyled">
										...
										<li><a href="#" class="inactive-color"
											onclick="location.href='../sign-in-up/Logout.jsp'"><span
												class="adonis-icon mr-3 icon-2x"><svg version="1.1"
														xmlns="http://www.w3.org/2000/svg" height="32"
														viewBox="0 0 32 32"> <path
										...
										<li><a href="#" class="inactive-color"
											onclick="location.href='../sign-in-up/index.html'"><span
												class="adonis-icon notification mr-3 icon-3x"><svg
														version="1.1" xmlns="http://www.w3.org/2000/svg"
														viewBox="0 0 32 32"> <path
														d="M10 6c0-3.314 2.686-6 6-6s6 2.686 6 6c0 3.314-2.686 6-6 6s-6-2.686-6-6zM24.002 14h-1.107l-6.222 12.633 2.327-11.633-3-3-3 3 2.327 11.633-6.222-12.633h-1.107c-3.998 0-3.998 2.687-3.998 6v10h24v-10c0-3.313 0-6-3.998-6z"></path></svg></span>Login/Sign up</a></li>
										<li><a href="#" class="inactive-color"><span
												class="adonis-icon mr-3 icon-3x"><svg version="1.1"
														xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
													<path d="M30 19l-9 9-3-3-2 2 5 5 11-11z"></path> <path
