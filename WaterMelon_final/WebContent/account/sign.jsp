					...
					<div class="tab-content">
						...
						<div class="tab-pane fade in" id="signup">
							<form id="sign-up" method="post" action="/SignUp.water">
								<div class="form-group">
									<label> 아이디<span class="req">*</span>
									</label> <input type="text" class="form-control" name="id" id="id" required
										data-validation-required-message="아이디를 입력 해 주세요!"
										autocomplete="off">
									<p class="help-block text-danger"></p>
								</div>
								<div class="row">
									<div class="col-xs-12 col-sm-6">
										<div class="form-group">
											<label> 비밀번호<span class="req">*</span>
											</label> <input type="password" class="form-control" name="password" id="password"
									...
									<div class="col-xs-12 col-sm-6">
										<div class="form-group">
											...
											</label> <input type="password" name="password_confirm" class="form-control"
								...
								<div class="form-group">
									...
									</label> <input type="text" class="form-control" name="nickname" id="nickname"
								...
								<div class="form-group">
									...
									</label> <input type="text" class="form-control" name="name" id="name" required
